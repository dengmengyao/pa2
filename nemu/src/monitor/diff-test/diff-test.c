...
void difftest_step(uint32_t eip) {
  ...
  if(r.eax != m.eax || r.ecx != m.ecx || r.edx != m.edx ||
		 r.ebx != m.ebx || r.esp != m.esp || r.ebp != m.ebp ||
		 r.esi != m.esi || r.edi != m.edi || r.eip != m.eip) {
    diff = true;
    printf("eax: qemu:0x%08x, m:0x%08x\n", r.eax, m.eax);
    printf("ecx: qemu:0x%08x, m:0x%08x\n", r.ecx, m.ecx);
    printf("edx: qemu:0x%08x, m:0x%08x\n", r.edx, m.edx);
    printf("ebx: qemu:0x%08x, m:0x%08x\n", r.ebx, m.ebx);
    printf("esp: qemu:0x%08x, m:0x%08x\n", r.esp, m.esp);
    printf("ebp: qemu:0x%08x, m:0x%08x\n", r.ebp, m.ebp);
    printf("esi: qemu:0x%08x, m:0x%08x\n", r.esi, m.esi);
    printf("edi: qemu:0x%08x, m:0x%08x\n", r.edi, m.edi);
    printf("eip: qemu:0x%08x, m:0x%08x\n", r.eip, m.eip);
  } 
